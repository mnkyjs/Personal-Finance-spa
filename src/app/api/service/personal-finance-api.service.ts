        ...
        return this.http
            ...
            .pipe(
                _observableCatch((response_: any) => {
                    ...
                    } else return <Observable<UserRegisterDto>>(<any>_observableThrow(response_));
                })
            );
    }
        ...
        if (status === 200) {
            return blobToText(responseBlob).pipe(
                _observableMergeMap((_responseText) => {
                    ...
                    result200 =
                        _responseText === '' ? null : <UserRegisterDto>JSON.parse(_responseText, this.jsonParseReviver);
        ...
        return this.http
            ...
            .pipe(
                _observableCatch((response_: any) => {
                    ...
                    } else return <Observable<AuthUserDto>>(<any>_observableThrow(response_));
                })
            );
    }
        ...
        if (status === 200) {
            return blobToText(responseBlob).pipe(
                _observableMergeMap((_responseText) => {
                    let result200: any = null;
                    result200 =
                        _responseText === '' ? null : <AuthUserDto>JSON.parse(_responseText, this.jsonParseReviver);
                    return _observableOf(result200);
                })
            );
        } else if (status !== 200 && status !== 204) {
        ...
        return this.http
            ...
            .pipe(
                _observableCatch((response_: any) => {
                    ...
                    } else return <Observable<CategorieDto>>(<any>_observableThrow(response_));
                })
            );
    }
        ...
        if (status === 200) {
            return blobToText(responseBlob).pipe(
                _observableMergeMap((_responseText) => {
                    let result200: any = null;
                    result200 =
                        _responseText === '' ? null : <CategorieDto>JSON.parse(_responseText, this.jsonParseReviver);
                    return _observableOf(result200);
                })
            );
        } else if (status !== 200 && status !== 204) {
        ...
        return this.http
            ...
            .pipe(
                _observableCatch((response_: any) => {
                    ...
                    } else return <Observable<TransactionDto>>(<any>_observableThrow(response_));
                })
            );
    }
        ...
        if (status === 200) {
            return blobToText(responseBlob).pipe(
                _observableMergeMap((_responseText) => {
                    let result200: any = null;
                    result200 =
                        _responseText === '' ? null : <TransactionDto>JSON.parse(_responseText, this.jsonParseReviver);
                    return _observableOf(result200);
                })
            );
        } else if (status !== 200 && status !== 204) {
            ...
            return blobToText(responseBlob).pipe(
                _observableMergeMap((_responseText) => {
                    ...
                    result200 =
                        _responseText === ''
                            ? null
                            : <TransactionDto[]>JSON.parse(_responseText, this.jsonParseReviver);
                    return _observableOf(result200);
                })
            );
        } else if (status !== 200 && status !== 204) {
