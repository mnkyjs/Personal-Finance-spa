...
export class FinanceApiService {
      ...
      .pipe(
        _observableCatch((response_: any) => {
          if (response_ instanceof HttpResponseBase) {
            ...
            return <Observable<UserRegisterDto>>(
  ...
  protected processDeleteCategory(
    response: HttpResponseBase
  ): Observable<void> {
    const status = response.status;
    const responseBlob =
      ...
      .pipe(
        _observableCatch((response_: any) => {
          if (response_ instanceof HttpResponseBase) {
            ...
            return <Observable<CategorieDto[]>>(
              (<any>_observableThrow(response_))
            );
        })
      );
  ...
  protected processGetAllCategories(
    response: HttpResponseBase
  ): Observable<CategorieDto[]> {
    const status = response.status;
    const responseBlob =
  ...
  protected processGetSingleCategoryById(
    response: HttpResponseBase
  ): Observable<CategorieDto[]> {
    const status = response.status;
    const responseBlob =
      ...
      .pipe(
        _observableCatch((response_: any) => {
          if (response_ instanceof HttpResponseBase) {
            ...
            return <Observable<TransactionDto>>(
              (<any>_observableThrow(response_))
            );
        })
      );
  ...
  protected processPostTransaction(
    response: HttpResponseBase
  ): Observable<TransactionDto> {
    const status = response.status;
    const responseBlob =
  ...
  protected processGetSingleTransactionById(
    response: HttpResponseBase
  ): Observable<TransactionDto[]> {
    const status = response.status;
    const responseBlob =
  ...
  protected processPutTransaction(
    response: HttpResponseBase
  ): Observable<TransactionDto> {
    const status = response.status;
    const responseBlob =
  ...
  protected processGetAllTransactionsInDateRange(
    response: HttpResponseBase
  ): Observable<TransactionDto[]> {
    const status = response.status;
    const responseBlob =
  ...
  init(_data?: any) {
    if (_data) {
      ...
      this.user = _data['user']
        ? UserLoginDto.fromJS(_data['user'])
        : <any>undefined;
    }
  }
